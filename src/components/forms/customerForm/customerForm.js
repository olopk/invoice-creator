...
const CustomerForm = (props) => {
  ...
  const save = async (data, keepOpen) => {
    ...
    customerData.selldate = selldate
      ? selldate.format("YYYY-MM-DD")
        ...
        >
          <Row>
            <Col span={18}>
              ...
              <Form.Item
                ...
                name="name"
                rules={[
                  { required: true, message: "Wpisz poprawna nazwe klienta" },
                ]}
              >
                <AutoComplete
                  ...
                  () => ({
                    validator(rule, value) {
                      ...
                      if (result.validateStatus === "success") {
                        ...
                        (!modalData || !modalData.hasInvoice) &&
                        result.errorMsg === "NIP nie może być pusty"
                      ) {
                        return Promise.resolve();
                      }
          ...
          <Row>
            <Col span={12}>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: modalData && modalData.hasInvoice ? true : false,
                    message: "Wpisz miejscowość",
                  },
                ]}
              >
                <AutoComplete placeholder="Miejscowość" />
              </Form.Item>
            </Col>
            <Col span={12}>
              ...
              >
                <AutoComplete placeholder="Ulica" />
              </Form.Item>
            </Col>
          </Row>
          <Row>
            <Col span={12}>
              ...
              <Form.Item
                ...
                name="phonenr"
              >
                <AutoComplete placeholder="Numer telefonu" />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Text style={{ textAlign: "left", display: "block" }}>
          ...
          <Row>
            <Col span={24}>
              ...
              >
                <TextArea rows={4} placeholder="Informacja dodatkowa." />
              </Form.Item>
            </Col>
          </Row>
          {!modalData ? (
              ...
              <Col span={11} offset={2}>
                <Form.Item>
                  <Button
                    ...
                    danger
                    block
                    onClick={save.bind(this, null, true)}
                  >
